...
/// Each explicit request can grant a reward once, solely from the SDK's
/// earned callback. Loading or closing an ad never grants an entitlement.
class RewardedAdManager {
  ...
  Future<void> dispose() async {
    ...
    if (completed != null && !completed.isCompleted) {
      // The running request's finally block owns its loaded ad's disposal.
